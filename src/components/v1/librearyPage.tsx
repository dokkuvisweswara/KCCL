...
export default function LibraryPage({lang}: any) {    
    ...
    let errorText = 'Your library is Empty' ;
    ...
    // let errorText1 = ' Please login to see your library'
    useEffect(()=>{
    ...
    const fetchAllFirebaseData=async()=>{
        try {             
            ...
            if (data) {    
                // let filterData = data.sort((a: any, b: any) => b.updatedat - a.updatedat)
                checkLanguage(data)                            
                // setFirebaseData(data)
                // filterDataFromFirebase(data);
            }     
        } catch (error) {
            ...
            <div className="flex w-full">            
                {
                    ...
                    <div className="mx-[2.5rem] mb-[1rem] max-lg:auto sub-container w-full max-md:ml-[-0.5rem] fadeAmination">
                    <div className="p-4">                         
