...
export const CONFIG_URL: string = ENV == 'PROD'? 'https://kccl-stage-default-rtdb.firebaseio.com/kccl_prod_config.json' : 'https://kccl-stage-default-rtdb.firebaseio.com/kccl_config.json';
export const THEME_COLOR = '#007bff';
export const PRODIVER_ID = ENV == 'PROD' ? 'keetv' : 'kccltvpr';
export const DEFAULT_LANGUAGE_SETUP = 'en';

export const CLIENT_KEY = ENV == 'PROD'? 'M4DDY41OZHjnXjwA' : 'TkpdehsIVC5n96K6';
export const APP_VERSION = ENV == 'PROD'? 'v2.0.5' : 'v1.0.0';
